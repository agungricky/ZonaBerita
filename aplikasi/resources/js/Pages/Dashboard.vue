...
import card2 from "../komponen/card-2.vue";
import { usePage } from "@inertiajs/vue3";

const {props: {count_post, count_populer, count_beritaUtama, konten_beritaCepat}} = usePage();
</script>
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            <div class="row">
              ...
              status="Telah Tayang"
              :jumlah="count_populer"
              deskripsi="Berita populer"
              footer_card ="Telah Terbit"
              />
              ...
              icon="bi bi-currency-dollar"
              status="Telah Tayang"
              :jumlah="konten_beritaCepat"
              deskripsi="Berita Cepat"
              footer_card ="Telah Terbit"
              />
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img
                                :src="'/public/admin/assets/img/product-1.jpg'"
                                alt=""
                            /></a>
                          </th>
                          <td>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img
                                :src="'/public/admin/assets/img/product-2.jpg'"
                                alt=""
                            /></a>
                          </th>
                          <td>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img
                                :src="'/public/admin/assets/img/product-3.jpg'"
                                alt=""
                            /></a>
                          </th>
                          <td>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img
                                :src="'/public/admin/assets/img/product-4.jpg'"
                                alt=""
                            /></a>
                          </th>
                          <td>
                        ...
                        <tr>
                          <th scope="row">
                            <a href="#"
                              ><img
                                :src="'/public/admin/assets/img/product-5.jpg'"
                                alt=""
                            /></a>
                          </th>
                          <td>
              ...
              <div class="card-body pb-0">
                ...
                <div class="news">
                  <div class="post-item clearfix">
                    <img :src="'/public/admin/assets/img/news-1.jpg'" alt="" />
                    <h4>
                  ...
                  <div class="post-item clearfix">
                    <img :src="'/public/admin/assets/img/news-2.jpg'" alt="" />
                    <h4>
                  ...
                  <div class="post-item clearfix">
                    <img :src="'/public/admin/assets/img/news-3.jpg'" alt="" />
                    <h4>
                      <a href="#"
                  ...
                  <div class="post-item clearfix">
                    <img :src="'/public/admin/assets/img/news-4.jpg'" alt="" />
                    <h4>
                  ...
                  <div class="post-item clearfix">
                    <img :src="'/public/admin/assets/img/news-5.jpg'" alt="" />
                    <h4>
