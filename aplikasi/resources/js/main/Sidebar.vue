      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a
            ...
            href="#"
          >
            <i class="bi bi-menu-button-wide"></i><span>Postingan</span
          ...
          >
            <li v-for="item in kategori" :key="item.idKategori">
              <a href="components-alerts.html">
                <i class="bi bi-circle"></i><span>{{ item.Kategori }}</span>
              </a>
            </li>
          </ul>
        </li>
