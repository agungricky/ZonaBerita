    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="index.html"><img src="{{ asset('public/news_portal/images/icons/logo-01.png') }}" alt="IMG-LOGO"></a>
            </div>
        ...
        <div class="wrap-logo container">
            <!-- Logo desktop -->
            <div class="logo">
                <a href="index.html"><img src="{{ asset('public/news_portal/images/icons/logo-01.png') }}" alt="LOGO"></a>
            </div>
